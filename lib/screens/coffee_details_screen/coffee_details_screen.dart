...
class CoffeeDetailsScreen extends StatelessWidget {
  const CoffeeDetailsScreen({super.key, required this.coffeModel});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(children: [
        BuyNowBottomBar(coffeModel: coffeModel),
        Column(
          ...
          children: [
            ...
            Text.rich(
              TextSpan(
                style:
                    Styles.bodyMedium(context).textColor(ThemeColors.hintText),
                children: [
